...
// is supplied. Links into /muslim/[state] for each state on file.
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `${HOST}/muslim` },
    openGraph: { title, description, url: `${HOST}/muslim` },
  };
}
