...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `${HOST}/muslimpopulation/${state}/${district}` },
    openGraph: {
      title,
      description,
      url: `${HOST}/muslimpopulation/${state}/${district}`,
    },
  };
}
...
`,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@id": `${HOST}/muslimpopulation/${state}/${district}/`,
            name: districtName,
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: `${HOST}/muslimpopulation/${state}/${district}/`,
              },
            ],
          }),
        }}
      ...
      <div className="vp-wrap">
        <nav className="vp-breadcrumb" aria-label="Breadcrumb">
          ...
          <span>›</span>
          <Link href={`/muslimpopulation/${state}`}>{stateName}</Link>
          <span>›</span>
        ...
        <div className="vp-layout">
          ...
          <aside className="vp-sidebar">
            ...
            <div className="vp-sidecard">
              <h3>Explore</h3>
              <Link className="vp-sidelink" href={`/muslimpopulation/${state}`}>
