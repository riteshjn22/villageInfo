...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `${HOST}/sikh/${state}/${district}` },
    openGraph: {
      title,
      description,
      url: `${HOST}/sikh/${state}/${district}`,
    },
  };
}
...
`,
      ...
      <div className="vp-wrap">
        <nav className="vp-breadcrumb" aria-label="Breadcrumb">
          ...
          <span>›</span>
          <Link href={`/sikh/${state}`}>{stateName}</Link>
          <span>›</span>
        ...
        <div className="vp-layout">
          ...
          <aside className="vp-sidebar">
            ...
            <div className="vp-sidecard">
              <h3>Explore</h3>
              <Link className="vp-sidelink" href={`/sikh/${state}`}>
