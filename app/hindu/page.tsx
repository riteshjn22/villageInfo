...
// is supplied. Links into /hindu/[state] for each state on file.
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `${HOST}/hindu` },
    openGraph: { title, description, url: `${HOST}/hindu` },
  };
}
