// deepak start - new file: Hindu Population feature (district-level page)
...
// HinduPopulationDistrict via getHinduPopulationDistricts().
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `${HOST}/hindu/${state}/${district}` },
    openGraph: {
      title,
      description,
      url: `${HOST}/hindu/${state}/${district}`,
    },
  };
}
...
`,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@id": `${HOST}/hindu/${state}/${district}/`,
            name: districtName,
            description: `Hindu population data for ${districtName}, ${stateName} based on Census ${census_year}.`,
            url: `${HOST}/hindu/${state}/${district}/`,
            address: {
              "@type": "PostalAddress",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Hindu Population", item: `${HOST}/hindu/` },
              { "@type": "ListItem", position: 3, name: stateName, item: `${HOST}/hindu/${state}/` },
              { "@type": "ListItem", position: 4, name: `Hindu Population in ${districtName}`, item: `${HOST}/hindu/${state}/${district}/` },
            ],
          }),
        }}
      />
      ...
      <div className="vp-wrap">
        <nav className="vp-breadcrumb" aria-label="Breadcrumb">
          <Link href="/hindu">Hindu Population</Link>
          <span>›</span>
          <Link href={`/hindu/${state}`}>{stateName}</Link>
          <span>›</span>
          <strong>Hindu Population in {districtName}</strong>
        </nav>
        ...
        <div className="vp-hero">
          <div className="vp-hero-top">
            <div>
              <h1 className="vp-h1">
                Hindu Population in {districtName}, {stateName} – Male,
                Female &amp; Sex Ratio
              </h1>
              <p className="vp-intro">
                As per <strong>Census {census_year}</strong>, {districtName}{" "}
                district in {stateName} has a Hindu population of{" "}
                <strong>{hindu_population}</strong>, accounting for{" "}
                <strong>{hindu_population_percent}%</strong> of the
                district&apos;s total population. The Hindu sex ratio is{" "}
        ...
        <div className="vp-layout">
          <main>
            <div className="vp-content-box">
              ...
              <div className="vp-section">
                <div className="vp-section-hd">
                  <h2>
                    Hindu Male &amp; Female Population in {districtName}
                  </h2>
                  <div className="vp-hd-line"></div>
                </div>
                <div className="vp-card">
              ...
              <div className="vp-section">
                <div className="vp-section-hd">
                  <h2>Urban &amp; Rural Hindu Population in {districtName}</h2>
                  <div className="vp-hd-line"></div>
                </div>
                <div className="vp-card">
                  <div className="vp-card-title">
          ...
          <aside className="vp-sidebar">
            <div className="vp-sidecard vp-sidecard-note">
              ...
              <p>
                This page presents Hindu population figures for{" "}
                {districtName} based on Census {census_year}. Hindu
                population percentage represents the share of Hindus in the
                total population. Hindu sex ratio represents females per
                1,000 Hindu males.
              </p>
            </div>
            ...
            <div className="vp-sidecard">
              ...
              <Link
                ...
                href={`/hindu/${state}`}
              >
                Hindu Population in {stateName}
              </Link>
              <Link className="vp-sidelink" href="/hindu">
