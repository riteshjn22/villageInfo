...
// is supplied. Links into /buddhist/[state] for each state on file.
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `${HOST}/buddhist` },
    openGraph: { title, description, url: `${HOST}/buddhist` },
  };
}
