...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `${HOST}/buddhist/${state}/${district}`,
    },
    openGraph: {
      title,
      description,
      url: `${HOST}/buddhist/${state}/${district}`,
    },
  };
}
...
`,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@id": `${HOST}/buddhist/${state}/${district}/`,
            name: districtName,
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: `${HOST}/buddhist/${state}/${district}/`,
              },
            ],
          }),
        }}
      ...
      <div className="vp-wrap">
        <nav className="vp-breadcrumb" aria-label="Breadcrumb">
          ...
          <span>›</span>
          <Link href={`/buddhist/${state}`}>{stateName}</Link>
          <span>›</span>
