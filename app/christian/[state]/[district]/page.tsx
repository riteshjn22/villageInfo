...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `${HOST}/christian/${state}/${district}`,
    },
    openGraph: {
      title,
      description,
      url: `${HOST}/christian/${state}/${district}`,
    },
  };
}
...
`,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@id": `${HOST}/christian/${state}/${district}/`,
            name: districtName,
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 3,
                name: stateName,
                item: `${HOST}/christian/${state}/`,
              },
              {
                "@type": "ListItem",
                position: 4,
                name: `Christian Population in ${districtName}`,
                item: `${HOST}/christian/${state}/${district}/`,
              },
            ],
          }),
        }}
      ...
      <div className="vp-wrap">
        <nav className="vp-breadcrumb" aria-label="Breadcrumb">
          <Link href="/christian">Christian Population</Link>
          <span>›</span>
          <Link href={`/christian/${state}`}>{stateName}</Link>
          <span>›</span>
          ...
          <aside className="vp-sidebar">
            ...
            <div className="vp-sidecard">
              ...
              <Link
                ...
                href={`/christian/${state}`}
              >
                Christian Population in {stateName}
              </Link>
              <Link className="vp-sidelink" href="/christian">
