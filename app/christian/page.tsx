...
// is supplied. Links into /christian/[state] for each state on file.
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `${HOST}/christian` },
    openGraph: { title, description, url: `${HOST}/christian` },
  };
}
