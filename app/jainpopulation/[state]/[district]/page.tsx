...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `${HOST}/jainpopulation/${state}/${district}` },
    openGraph: {
      title,
      description,
      url: `${HOST}/jainpopulation/${state}/${district}`,
    },
  };
}
...
`,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@id": `${HOST}/jainpopulation/${state}/${district}/`,
            name: districtName,
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: `${HOST}/jainpopulation/${state}/${district}/`,
              },
            ],
          }),
        }}
      ...
      <div className="vp-wrap">
        <nav className="vp-breadcrumb" aria-label="Breadcrumb">
          ...
          <span>›</span>
          <Link href={`/jainpopulation/${state}`}>{stateName}</Link>
          <span>›</span>
        ...
        <div className="vp-layout">
          ...
          <aside className="vp-sidebar">
            ...
            <div className="vp-sidecard">
              <h3>Explore</h3>
              <Link className="vp-sidelink" href={`/jainpopulation/${state}`}>
