...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `${HOST}/hindupopulation/${state}/${district}` },
    openGraph: {
      title,
      description,
      url: `${HOST}/hindupopulation/${state}/${district}`,
    },
  };
}
...
`,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@id": `${HOST}/hindupopulation/${state}/${district}/`,
            name: districtName,
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 4, name: `Hindu Population in ${districtName}`, item: `${HOST}/hindupopulation/${state}/${district}/` },
            ],
          }),
        }}
      />
      ...
      <div className="vp-wrap">
        <nav className="vp-breadcrumb" aria-label="Breadcrumb">
          ...
          <span>›</span>
          <Link href={`/hindupopulation/${state}`}>{stateName}</Link>
          <span>›</span>
