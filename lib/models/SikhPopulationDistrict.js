...
// deepak start - new file: Sikh Population feature (district level)
...
const SikhPopulationDistrictSchema = new mongoose.Schema(
  {
...
SikhPopulationDistrictSchema.index(
  { state_slug: 1, district_slug: 1 },
  { unique: true },
);

const SikhPopulationDistrict =
  mongoose.models.SikhPopulationDistrict ||
  mongoose.model("SikhPopulationDistrict", SikhPopulationDistrictSchema);

export default SikhPopulationDistrict;
// deepak end - new file
